...
class StoreOutsideRepositoryImpl @Inject constructor(
    ...
    override fun getCheckList(): Flow<Resource<List<CheckItem>>> {
        return flow {
            try {
                ...
                val result = storeTaskApi.getStoreOutsideCheckList()
        ...
        return flow {
            try {
                ...
                userId?.let { id ->
                    ...
                    val result = storeTaskApi.sendStoreOutSideCheckList(body)
                    if (result.response.success) {

...
import com.hakmar.employeelivetracking.features.store_detail_tasks.ui.viewmodel.StoreInsideViewModel

class StoreInsideScreen : Screen {
    ...
    override fun Content() {
        ...
        val viewModel: StoreInsideViewModel = getViewModel()
